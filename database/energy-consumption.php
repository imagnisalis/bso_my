...
$databaseTitle = "Energy Consumption";
...
<head>
    ...
    <script type="module" src="../assets/js/categories-energy-consumption.js"></script>
            ...
            <div  class="card card-border-start border-blue" id="BSOFormAfterDIV" style="display: none;">
                <div class="row">
                    <div class="d-flex flex-row-reverse col-12 pt-2 pt-md-3 pb-md-3">
                        <div class="px-2">
                            <span><a href="energy-consumption.php" class="btn btn-primary mx-1 mb-2 mb-md-0">Start over</a></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function BSOFormSubmit() {
        ...
        function convertSubcategoriesToPowerBiFormat (categoriesJSONArray) {
            ...
            for(let i = 0; i < parts.length; i++) {
                let categoryObject = {};
                if (parts[i] === "Residential") {
                    categoryObject.operator = "Is";
                    categoryObject.value = "Residential final energy consumption (Mtoe)";
                    categoriesArray.push(categoryObject);
                }
                else if (parts[i] === "Services") {
                    categoryObject.operator = "Is";
                    categoryObject.value = "Services final energy consumption (Mtoe)";
                    categoriesArray.push(categoryObject);
                }
            }
            return categoriesArray;
