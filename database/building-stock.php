                        ...
                        <div class="row">
                            <div class="d-flex flex-row-reverse col-12 pt-2 pt-md-0">
                                <div>
                                    ...
                                    <span><a onclick="BSOFormSubmit()" type="submit" class="btn btn-primary mx-1 mb-2 mb-md-0">Get diagram</a></span>
                                </div>
                            </div>
            ...
            <div  class="card card-border-start border-blue" id="BSOFormAfterDIV" style="display: none;">
                <div class="row">
                    <div class="d-flex flex-row-reverse col-12 pt-2 pt-md-3 pb-md-3">
                        <div class="px-2">
                            <span><a href="building-stock.php" class="btn btn-primary mx-1 mb-2 mb-md-0">Start over</a></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function BSOFormSubmit() {
        ...
        function convertCategoriesToPowerBiFormat (categoriesJSONArray) {
            ...
            for(let i = 0; i < parts.length; i++) {
                let categoryObject = {};
                if (parts[i] === "Education" || parts[i] === "Health" || parts[i] === "Hotels and restaurants"
                    || parts[i] === "Office" || parts[i] === "Wholesale and retail trade" || parts[i] === "Other" || parts[i] === "N/A ")
                {
                    categoryObject.operator = "Is";
                    categoryObject.value = "Non-residential";
                    categoriesArray.push(categoryObject);
                }
                else if (parts[i] === "Apartment blocks" || parts[i] === "N/A" || parts[i] === "Single Family House")
                {
                    categoryObject.operator = "Is";
                    categoryObject.value = "Residential";
                    categoriesArray.push(categoryObject);
                }
                else if (parts[i] === "Whole building stock")
                {
                    categoryObject.operator = "Is";
                    categoryObject.value = "Whole building stock";
                    categoriesArray.push(categoryObject);
                }
            }
        ...
        //// SUBCATEGORIES
        function convertSubcategoriesToPowerBiFormat (categoriesJSONArray) {
            let parts = categoriesJSONArray.split('\n');
            let categoriesArray = [];
            for(let i = 0; i < parts.length; i++) {
                let categoryObject = {};
        ...
        let subcategoriesArray = convertSubcategoriesToPowerBiFormat(categoriesText);
